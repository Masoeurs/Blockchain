...
from MSSF.consensus.block_header_validation import validate_finished_header_block
...
from MSSF.consensus.deficit import calculate_deficit
from MSSF.consensus.full_block_to_block_record import header_block_to_sub_block_record
from MSSF.consensus.pot_iterations import (
    calculate_ip_iters,
    calculate_iterations_quality,
    calculate_sp_iters,
    is_overflow_block,
)
from MSSF.consensus.vdf_info_computation import get_signage_point_vdf_info
...
from MSSF.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
from MSSF.types.blockchain_format.sub_epoch_summary import SubEpochSummary
from MSSF.types.blockchain_format.vdf import VDFInfo, VDFProof, validate_vdf
from MSSF.types.end_of_slot_bundle import EndOfSubSlotBundle
from MSSF.types.header_block import HeaderBlock
from MSSF.types.weight_proof import (
    RecentChainData,
...
from MSSF.util.block_cache import BlockCache
...
def _create_shutdown_file() -> IO[bytes]:
    return tempfile.NamedTemporaryFile(prefix="MSSF_full_node_weight_proof_handler_executor_shutdown_trigger")
