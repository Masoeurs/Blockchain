...
from MSSF.util.collection import find_duplicates
from MSSF.util.db_synchronous import db_synchronous_on
from MSSF.util.db_wrapper import DBWrapper2, execute_fetchone
from MSSF.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in MSSF wallet databases.
    The core MSSF client currently uses sqlite to store the wallet databases, one database per key.
\b
