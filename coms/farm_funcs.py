...
from MSSF.util.misc import format_bytes, format_minutes
from MSSF.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total MSSF farmed: {amounts['farmed_amount'] / units['MSSF']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['MSSF']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['MSSF']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'MSSF start wallet' and 'MSSF wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'MSSF wallet show'")
    else:
        print("Note: log into your key using 'MSSF wallet show' to see rewards for each key")
