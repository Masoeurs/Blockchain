...
def create_data_store(
    ...
    from MSSF.cmds.data_funcs import create_data_store_cmd
...
def get_value(
    ...
    from MSSF.cmds.data_funcs import get_value_cmd
...
def update_data_store(
    ...
    from MSSF.cmds.data_funcs import update_data_store_cmd
...
def submit_pending_root(
    ...
    from MSSF.cmds.data_funcs import submit_pending_root_cmd
...
def get_keys(
    ...
    from MSSF.cmds.data_funcs import get_keys_cmd
...
def get_keys_values(
    ...
    from MSSF.cmds.data_funcs import get_keys_values_cmd
...
def get_root(
    ...
    from MSSF.cmds.data_funcs import get_root_cmd
...
def subscribe(
    ...
    from MSSF.cmds.data_funcs import subscribe_cmd
...
def remove_subscription(
    ...
    from MSSF.cmds.data_funcs import remove_subscriptions_cmd
...
def unsubscribe(
    ...
    from MSSF.cmds.data_funcs import unsubscribe_cmd
...
def get_kv_diff(
    ...
    from MSSF.cmds.data_funcs import get_kv_diff_cmd
...
def get_root_history(
    ...
    from MSSF.cmds.data_funcs import get_root_history_cmd
...
def add_missing_files(
    ...
    from MSSF.cmds.data_funcs import add_missing_files_cmd
...
def add_mirror(
    ...
    from MSSF.cmds.data_funcs import add_mirror_cmd
...
def delete_mirror(
    ...
    from MSSF.cmds.data_funcs import delete_mirror_cmd
...
def get_mirrors(
    ...
    from MSSF.cmds.data_funcs import get_mirrors_cmd
...
def get_subscriptions(
    ...
    from MSSF.cmds.data_funcs import get_subscriptions_cmd
...
def get_owned_stores(
    ...
    from MSSF.cmds.data_funcs import get_owned_stores_cmd
...
def get_sync_status(
    ...
    from MSSF.cmds.data_funcs import get_sync_status_cmd
...
def check_plugins(
    ...
    from MSSF.cmds.data_funcs import check_plugins_cmd
...
def clear_pending_roots(
    ...
    from MSSF.cmds.data_funcs import clear_pending_roots
...
def wallet_log_in(
    ...
    from MSSF.cmds.data_funcs import wallet_log_in_cmd
...
def get_proof(
    ...
    from MSSF.cmds.data_funcs import get_proof_cmd
...
def verify_proof(
    ...
    from MSSF.cmds.data_funcs import verify_proof_cmd
