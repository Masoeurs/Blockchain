...
@click.option("--testnet", is_flag=True, help="Configure this MSSF install to connect to the testnet")
...
def init_cmd(
    ...
    from MSSF.cmds.passphrase_funcs import initialize_passphrase
...
if __name__ == "__main__":
    ...
    from .init_funcs import MSSF_init

    MSSF_init(DEFAULT_ROOT_PATH)
