...
from MSSF.cmds.cmds_util import NODE_TYPES
from MSSF.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified MSSF service to ip:port", type=str, default="")
@click.option(
