...
from MSSF.daemon.client import acquire_connection_to_daemon
from MSSF.util.errors import KeychainMaxUnlockAttempts
from MSSF.util.keychain import Keychain, supports_os_passphrase_storage
from MSSF.util.keyring_wrapper import DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE, KeyringWrapper
from MSSF.util.misc import prompt_yes_no
    ...
    try:
        if supports_os_passphrase_storage():
            ...
            print(
                ...
                "Other MSSF processes will be able to access your keys without prompting for your passphrase."
            )
...
def read_passphrase_from_file(passphrase_file: TextIOWrapper) -> str:
    passphrase = passphrase_file.read().rstrip(os.environ.get("MSSF_PASSPHRASE_STRIP_TRAILING_CHARS", "\r\n"))
...
def initialize_passphrase() -> None:
    if Keychain.has_master_passphrase():
        ...
        print("\nUse 'MSSF passphrase set' or 'MSSF passphrase remove' to update or remove your passphrase")
        sys.exit(1)
