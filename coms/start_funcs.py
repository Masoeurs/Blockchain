...
from MSSF.cmds.passphrase_funcs import get_current_passphrase
from MSSF.daemon.client import DaemonProxy, connect_to_daemon_and_validate
from MSSF.util.errors import KeychainMaxUnlockAttempts
from MSSF.util.keychain import Keychain
from MSSF.util.service_groups import services_for_groups
...
async def async_start(root_path: Path, config: Dict[str, Any], group: tuple[str, ...], restart: bool) -> None:
    ...
    if daemon is None:
        print("Failed to create the MSSF daemon")
        return None
