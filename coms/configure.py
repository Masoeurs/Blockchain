    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet11.MSSF.net"
                testnet_dns_introducer = "dns-introducer-testnet11.MSSF.net"
                bootstrap_peers = ["testnet11-node-us-west-2.MSSF.net"]
                testnet = "testnet11"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.MSSF.net"
                mainnet_dns_introducer = "dns-introducer.MSSF.net"
                bootstrap_peers = ["node.MSSF.net"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running MSSF services for changes to take effect")
