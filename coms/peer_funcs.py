...
from MSSF.cmds.cmds_util import NODE_TYPES, get_any_service_client
from MSSF.rpc.rpc_client import RpcClient
...
async def print_connections(rpc_client: RpcClient, trusted_peers: Dict[str, Any]) -> None:
    ...
    from MSSF.server.outbound_message import NodeType
    from MSSF.util.network import is_trusted_peer
