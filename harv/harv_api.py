...
from MSSF.harvester.harvester import Harvester
from MSSF.plotting.util import PlotInfo, parse_plot_info
from MSSF.protocols import harvester_protocol
from MSSF.protocols.farmer_protocol import FarmingInfo
from MSSF.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from MSSF.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSMSSFConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSMSSFConnection
    ) -> None:
        """
