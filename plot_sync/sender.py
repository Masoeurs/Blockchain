...
from MSSF.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from MSSF.plot_sync.util import Constants
from MSSF.plotting.manager import PlotManager
from MSSF.plotting.util import HarvestingMode, PlotInfo
...
class Sender:
    ...
    _connection: Optional[WSMSSFConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSMSSFConnection) -> None:
