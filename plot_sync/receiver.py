...
from MSSF.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from MSSF.plot_sync.exceptions import (
...
from MSSF.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
from MSSF.plotting.util import HarvestingMode
...
from MSSF.server.outbound_message import make_msg
from MSSF.server.ws_connection import WSMSSFConnection
from MSSF.types.blockchain_format.sized_bytes import bytes32
from MSSF.util.ints import int16, uint32, uint64
from MSSF.util.misc import get_list_or_len
...
class Receiver:
    ...
    def connection(self) -> WSMSSFConnection:
