...
from MSSF.data_layer.data_layer_errors import ProofIntegrityError
...
from MSSF.util.ints import uint8, uint64
from MSSF.util.streamable import Streamable, streamable
from MSSF.wallet.db_wallet.db_wallet_puzzles import create_host_fullpuz

if TYPE_CHECKING:
    from MSSF.data_layer.data_store import DataStore
    from MSSF.wallet.wallet_node import WalletNode
...
@dataclasses.dataclass(frozen=True)
class Layer:
    # This class is similar to MSSF.data_layer.data_layer_util.ProofOfInclusionLayer
