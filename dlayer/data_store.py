...
from MSSF.data_layer.data_layer_errors import KeyNotFoundError, NodeHashError, TreeGenerationIncrementingError
...
class DataStore:
    ...
    async def get_tree_as_program(self, tree_id: bytes32) -> Program:
        async with self.db_wrapper.reader() as reader:
            ...
            #       https://github.com/MSSF-Network/clvm/pull/102
            #       https://github.com/MSSF-Network/clvm/pull/106
